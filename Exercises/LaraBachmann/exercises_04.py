...
def simulated_computer(lst):
    ...
    while True:
        ...
        if opcode in [1, 2, 7, 8]:
            param1 = get_parameter(lst, lst[pointer + 1], modes[0])
            param2 = get_parameter(lst, lst[pointer + 2], modes[1])
...
testcase_1 = [3,9,8,9,10,9,4,9,99,-1,8]
testcase_2 = [3,3,1107,-1,8,3,4,3,99]
testcase_3 = [3,3,1105,-1,9,1101,0,0,12,4,12,99,1]
testcase_4 = [1002,4,3,4,33]
1002,4,3,4,33
simulated_computer(testcase_4)