...
def strings(*args):
    ...
    for arg in args:
        ...
        if len(arg) == 1:
            single_character.append(arg)
        
        return numbers, single_character
    
test1 = strings("1", "a", "3.14", "hello", "b", "42", "x")
test2 = strings("100", "!", "2.718", "world", "y", "z", "0")
test3 = strings("apple", "banana", "3", "4.5", "c", "d", "e")
