...
def sorting(*starting_list):
    ...
    print('There are' , len(number_list) , 'elements')
    print('This ist the char list:' , one_charakter_list)
    print('There are' , len(one_charakter_list) , 'elements')


print('testlist_1: Straße , 2 , 0 , x , 35 , Baum , 2.4 , g , w')
print('testing testlist_1. Following numbers shoud return: 2, 0, 35, 2.4. in total 4 numbers')
print('Following char should return: 2, 0, g, x, w. in total 5 chars')
sorting('Straße' , '2' , '0' , 'x' , '35' , 'Baum' , '2.4' , 'g' , 'w')

print('\ntestlist_2: Python , Java , cplusplus , pascal , 1 , 4 , z , 7')
print('testing testlist_2. Following numbers shoud return: 1, 4, 7. in total 3 numbers')
print('Following char should return: 1, 4, z. in total 3 chars')
sorting('Python' , 'Java' , 'cplusplus' , 'pascal', '1' , '4' , 'z' , '7')

print('\ntestlist_3: 4, 4.8 , / ,  , z/m , arrow , q , i')
print('testing testlist_3. Following numbers shoud return: 4, 4.8. in total 2 numbers')
print('Following char should return: 4, /, q, i. in total 4 chars')
sorting('4', '4.8' , '/' , '' , 'k/m' , 'arrow' , 'q' , 'i')