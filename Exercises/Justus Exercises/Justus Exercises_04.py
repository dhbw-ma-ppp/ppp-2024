...
def intcode_computer(memory, input_val=0):
    ...
    while i < len(memory):
        ...
        mode1, mode2, mode3 = modes  # unpack modes 

        if opcode == 99:
            break  # Halt

        elif opcode == 1:  # Addition
            param1, param2, param3 = memory[i + 1:i + 4]
            memory[param3] = get_value(param1, mode1) + get_value(param2, mode2)
            i += 4
            ...
            param1, param2, param3 = memory[i + 1:i + 4]
            memory[param3] = 1 if get_value(param1, mode1) < get_value(param2, mode2) else 0
            i += 4
