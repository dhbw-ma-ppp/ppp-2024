...
def investigation (start):
    ...
    match opcode:
        case '01':
            start = addition(start, instruction)
            return start, end
        case '02':
            start = multiplication(start, instruction)
            return start, end
        case '03':
            start = inputs(start)
            return start, end
        ...
        case '05':
            ...
            return start, end
        case '06':
            start = jump_if_false(start, instruction)
            return start, end
        case '07':
            start = less_than(start, instruction)
            return start, end
        case '08':
            start = equals(start, instruction)
            return start, end
        case '99':
            end = True
            return 1, end
