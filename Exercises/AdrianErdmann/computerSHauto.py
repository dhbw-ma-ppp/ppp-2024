# Represents Soerens int computer cause mine did some weird stuff (I wansn't able to move the paddle, the rest worked)
import subprocess
import enum
import os
...
class ExecutionManager:
    ...
    def computeToNextTriplet(self, best_move_new):
        global best_move
        best_move = best_move_new
        global return_list
        return_list = []
        end = False
